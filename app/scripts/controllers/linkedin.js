searchGuardianApp.controller('LiCtrl',
  function ($scope,$rootScope) {
    //$rootScope.linkedin-authorize = '';
    //$rootScope.linkedin-profile-data = '';
  });

searchGuardianApp.directive('myLinkedin',
        ['$rootScope', '$interval',
            function ($rootScope, $interval) {
                return {
                    restrict: 'AE',
                    replace: true,
                    templateUrl: 'views/angular-linkedin-login-ptl.html',
                    scope: true,
                    compile: function (tElem, tAttrs) {
                        ...
                        return function (scope, elem, attrs) {
                            ...
                            var _authorizedHandler = _authorizedHandlerName ? scope[_authorizedHandlerName] : null;
                            ...
                            //_authorizedHandler = true;
                            //_profileDataHandler = true;
